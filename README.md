...
1. 🚀 Published release [v0.4.6](https://github.com/AACTools/VoiceGarden-SAPI/releases/tag/v0.4.6) in [AACTools/VoiceGarden-SAPI](https://github.com/AACTools/VoiceGarden-SAPI)
2. 🚀 Published release [v0.4.5](https://github.com/AACTools/VoiceGarden-SAPI/releases/tag/v0.4.5) in [AACTools/VoiceGarden-SAPI](https://github.com/AACTools/VoiceGarden-SAPI)
3. 🚀 Published release [v0.4.3](https://github.com/AACTools/VoiceGarden-SAPI/releases/tag/v0.4.3) in [AACTools/VoiceGarden-SAPI](https://github.com/AACTools/VoiceGarden-SAPI)
4. 🎉 Merged PR [#7](https://github.com/AACTools/rust-tts-wrapper/pull/7) in [AACTools/rust-tts-wrapper](https://github.com/AACTools/rust-tts-wrapper)
5. 🗣 Commented on [#17](https://github.com/dasher-project/Dasher-GTK/issues/17#issuecomment-4939238807) in [dasher-project/Dasher-GTK](https://github.com/dasher-project/Dasher-GTK)
