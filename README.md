...
1. 🎉 Merged PR [#2](https://github.com/willwade/SherpaOnnxSAPI-installer/pull/2) in [willwade/SherpaOnnxSAPI-installer](https://github.com/willwade/SherpaOnnxSAPI-installer)
2. 💪 Opened PR [#2](https://github.com/willwade/SherpaOnnxSAPI-installer/pull/2) in [willwade/SherpaOnnxSAPI-installer](https://github.com/willwade/SherpaOnnxSAPI-installer)
3. ❗ Opened issue [#1](https://github.com/willwade/SherpaOnnxSAPI-installer/issues/1) in [willwade/SherpaOnnxSAPI-installer](https://github.com/willwade/SherpaOnnxSAPI-installer)
4. 🚀 Published release [v0.1.10](https://github.com/willwade/envloader/releases/tag/v0.1.10) in [willwade/envloader](https://github.com/willwade/envloader)
5. 🚀 Published release [v0.1.9](https://github.com/willwade/envloader/releases/tag/v0.1.9) in [willwade/envloader](https://github.com/willwade/envloader)
